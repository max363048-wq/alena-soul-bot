...
def generate_story(prompt: str, user_id: int, lang: str, client, gist_id: str) -> str:
    system_prompt = (
        ...
        'ЗАПРЕЩЕНО: войны, политика, разведчики, странные предметы (компас, цветок на свадьбе сестры), неестественные числа (девятнадцать лет назад).\n'
        'Перед отправкой проверь грамматику: все слова должны быть в правильной форме, без "весную", "поразговаривать", "обедение".\n'
