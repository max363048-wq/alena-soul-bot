# voice.py — Модуль голоса и слуха Алёны (голос молодой девушки)
...
# ---------- СИНТЕЗ РЕЧИ (Microsoft Edge TTS, молодой голос) ----------
def text_to_speech(text: str, lang: str = 'ru') -> Optional[bytes]:
    """Синтезирует голос Алёны через Microsoft Edge TTS (бесплатно, молодой голос)."""
    try:
        import edge_tts
        # Молодой женский голос: ru-RU-DariyaNeural (русский), en-US-AriaNeural (английский)
