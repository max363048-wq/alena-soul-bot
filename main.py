# main.py — минимальный тест OpenRouter
...
print("!!! ЗАПУСК МИНИМАЛЬНОГО ТЕСТА OPENROUTER !!!")
...
def send_welcome(message):
    bot.reply_to(message, "Привет! Я Алёна. Тест OpenRouter.")
...
if __name__ == '__main__':
    ...
    print("Тестовый бот OpenRouter запущен")
    try:
