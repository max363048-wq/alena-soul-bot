# main.py — Полная версия с вебхуками (без long polling)
...
# ---------- Команды и обработчики (все без изменений) ----------
...
# ---------- Запуск (установка вебхука и запуск Flask) ----------
if __name__ == '__main__':
    ...
    webhook_url = "https://alena-soul-bot.onrender.com/webhook"
