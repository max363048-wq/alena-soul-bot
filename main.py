...
# --- Системный промпт (теперь с правилом 8 про инициативу) ---
...
# --- Основной обработчик (остальной код без изменений) ---
# ... (весь код handle_message и остальное остаётся тем же, что ты прислал) ...
